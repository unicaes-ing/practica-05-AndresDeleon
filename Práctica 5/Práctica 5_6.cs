    ...
    class Práctica_5_6
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                if (int.TryParse(Console.ReadLine(), out c) && c >= 0)
                {
                    ...
                    for (int i = 0; i <= c - 1; i++)
                    {
                        ...
                        do
                        {
                            ...
                            {
                                Console.WriteLine("El valor tiene que ser un decimal positivo entre 0 y 10 :(");
                                rep = true;
                            }
                        } while (rep == true);
                ...
                {
                Console.WriteLine("El valor tiene que ser un entero positivo :(");
                rep = true;
                }
            } while (rep == true);
            Console.WriteLine("===============================================================");
            Console.WriteLine("Nota Promedio del Examen: " + promedio(sum, c).ToString("N2"));
            Console.WriteLine("===============================================================");
            Console.ReadKey();
        }
